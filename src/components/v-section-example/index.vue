<template>
  <VPageSection :offset="2" :size="8" class="section-example">
    <section>
      <header class="section-example__header">
        <h2 class="section-example__title">
...
<style lang="scss" src="./v-section-example.scss" />
